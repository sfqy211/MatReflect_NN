...
class SystemService:
    ...
    def _build_checks(self, settings: SystemSettings) -> List[SystemDependencyCheck]:
        ...
        checks = [
            ...
            self._check_path("snbrdf_output_dir", "SNBRDF 输出根目录", settings.snbrdf_output_dir, expect="dir", base_dir=project_root),
    ...
    def _coerce_settings_request(self, request: SystemSettingsRequest) -> SystemSettings:
        ...
        return SystemSettings(
            ...
            snbrdf_output_dir=request.snbrdf_output_dir.strip() or defaults.snbrdf_output_dir,
