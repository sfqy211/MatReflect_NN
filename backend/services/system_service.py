...
class SystemService:
    ...
    def _build_checks(self, settings: SystemSettings) -> List[SystemDependencyCheck]:
        ...
        checks = [
            ...
            self._check_path("materials_dir", "原始材质目录", settings.materials_dir, expect="dir", base_dir=project_root),
            self._check_path("nbrdf_render_input_dir", "Neural-BRDF 渲染输入", settings.nbrdf_render_input_dir, expect="dir", base_dir=project_root),
            self._check_path("hyperbrdf_render_input_dir", "HyperBRDF 渲染输入", settings.hyperbrdf_render_input_dir, expect="dir", base_dir=project_root),
            self._check_path("merl_render_dir", "MERL 渲染目录", settings.merl_render_dir, expect="dir", base_dir=project_root),
            self._check_path("nbrdf_render_dir", "Neural-BRDF 渲染目录", settings.nbrdf_render_dir, expect="dir", base_dir=project_root),
            self._check_path("hyperbrdf_render_dir", "HyperBRDF 渲染目录", settings.hyperbrdf_render_dir, expect="dir", base_dir=project_root),
            self._check_path("snbrdf_render_dir", "HyperSNBRDF 渲染目录", settings.snbrdf_render_dir, expect="dir", base_dir=project_root),
            self._check_path("grids_dir", "网格拼图输出目录", settings.grids_dir, expect="dir", base_dir=project_root),
            self._check_path("comparisons_dir", "对比拼图输出目录", settings.comparisons_dir, expect="dir", base_dir=project_root),
    ...
    def _coerce_settings_request(self, request: SystemSettingsRequest) -> SystemSettings:
        ...
        return SystemSettings(
            ...
            materials_dir=request.materials_dir.strip() or defaults.materials_dir,
            nbrdf_render_input_dir=request.nbrdf_render_input_dir.strip() or defaults.nbrdf_render_input_dir,
            hyperbrdf_render_input_dir=request.hyperbrdf_render_input_dir.strip() or defaults.hyperbrdf_render_input_dir,
            merl_render_dir=request.merl_render_dir.strip() or defaults.merl_render_dir,
            nbrdf_render_dir=request.nbrdf_render_dir.strip() or defaults.nbrdf_render_dir,
            hyperbrdf_render_dir=request.hyperbrdf_render_dir.strip() or defaults.hyperbrdf_render_dir,
            snbrdf_render_dir=request.snbrdf_render_dir.strip() or defaults.snbrdf_render_dir,
            grids_dir=request.grids_dir.strip() or defaults.grids_dir,
            comparisons_dir=request.comparisons_dir.strip() or defaults.comparisons_dir,
