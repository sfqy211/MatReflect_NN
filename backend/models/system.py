...
class SystemSettings(BaseModel):
    ...
    mtsutil_exe: str
    materials_dir: str
    nbrdf_render_input_dir: str
    hyperbrdf_render_input_dir: str
    merl_render_dir: str
    nbrdf_render_dir: str
    hyperbrdf_render_dir: str
    snbrdf_render_dir: str
    grids_dir: str
    comparisons_dir: str
    preset_label: str
    conda_env: str
...
class SystemSettingsRequest(BaseModel):
    ...
    materials_dir: str = Field(default="", max_length=1024)
    nbrdf_render_input_dir: str = Field(default="", max_length=1024)
    hyperbrdf_render_input_dir: str = Field(default="", max_length=1024)
    merl_render_dir: str = Field(default="", max_length=1024)
    nbrdf_render_dir: str = Field(default="", max_length=1024)
    hyperbrdf_render_dir: str = Field(default="", max_length=1024)
    snbrdf_render_dir: str = Field(default="", max_length=1024)
    grids_dir: str = Field(default="", max_length=1024)
    comparisons_dir: str = Field(default="", max_length=1024)
