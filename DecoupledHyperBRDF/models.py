...
# from torchmeta.modules import get_subdict
import re
import warnings
from collections import OrderedDict
...
class SingleBVPNet(MetaModule):
    ...
    def __init__(self, out_features=1, type='relu', in_features=2, mode='mlp', hidden_features=256, num_hidden_layers=3,
        ...
        self.net = FCBlock(in_features=in_features, out_features=out_features, num_hidden_layers=num_hidden_layers,
                           hidden_features=hidden_features, outermost_linear=False, nonlinearity=type)
        # print(self)
...
class HyperBRDF(nn.Module):
    ...
    def __init__(self, in_features, out_features, encoder_nl='relu'):
        ...
        self.hypo_net = SingleBVPNet(out_features=out_features, hidden_features=60, type='relu',
                                     in_features=6)
        self.hyper_net = HyperNetwork(hyper_in_features=latent_dim, hyper_hidden_layers=10, hyper_hidden_features=128,
    ...
    def forward(self, model_input):
        ...
        # Determine inputs for encoder (prefer sparse context if available)
